  ...
  return (
    ...
    >
        <g id="PAGE-INTERACTION" serifId="PAGE INTERACTION" transform="matrix(1,0,0,1,-182,-503)">
            <g transform="matrix(1,0,0,1,321,263)">
                <g>
                    <text 
                      x="19px" 
                      y="297.688px" 
                    ...
                    >O<tspan x="43.413px 68.588px " y="297.688px 297.688px ">UR</tspan>STO<tspan x="172.067px 197.299px " y="297.688px 297.688px ">RY</tspan></text>
                </g>
            </g>
