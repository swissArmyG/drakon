...
export const HomepageEducation = forwardRef((_, ref) => {
  return (
    <section ref={ref} className="HomepageEducation --container">
      <Zoom>
        <img 
          className="HomepageEducation --infobox-left"
          src={`${infoboxLeft}`} 
        ...
        <img 
          className="HomepageEducation --infobox-right" 
          src={`${infoboxRight}`} 
